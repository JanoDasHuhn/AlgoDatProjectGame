...
/**
 * Die Klasse {@code Entity} repräsentiert eine besondere Art von Encounter mit zusätzlichen Attributen
 * wie Lebenspunkten, Schadenswert, Entitätstyp und einem Item.
 */
public class Entity extends Encounter {
    ...
    /**
     * Verstärkt die Werte (Stats) der Entität abhängig vom übergebenen Boost-Wert.
     * Diese Methode ist aktuell noch in Arbeit und hat keine Implementierung.
     *
