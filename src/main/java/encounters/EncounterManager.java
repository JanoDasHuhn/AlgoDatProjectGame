...
/**
 * Die Klasse {@code EncounterManager} verwaltet eine Liste von Encountern. Sie ermöglicht das
 * Hinzufügen, Abrufen und Filtern von Encountern nach Typ. Zudem können die Stats der Enemies
...
public class EncounterManager {
  ...
  /**
   * Konstruktor für {@code EncounterManager}. Erstellt eine leere Liste von Encountern.
   */
  ...
  /**
   * Gibt das Encounter an der angegebenen Position zurück. Wenn kein Encounter vorhanden ist, wird
   * das erste Encounter zurückgegeben.
   *
  ...
  /**
   * Gibt ein zufälliges Encounter eines bestimmten Raum-Typs zurück. Interne Hilfsmethode, wird von
   * {@link #getRandomEncounter(RoomType, int)} verwendet.
   *
