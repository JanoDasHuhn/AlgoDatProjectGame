...
/**
 * Die Klasse {@code RoomManager} verwaltet eine Liste aller Räume im Spiel.
 * Sie kann neue Räume generieren und einzelne Räume abrufen.
 */
public class RoomManager {
    ...
    /**
     * Konstruktor für {@code RoomManager}.
     * Initialisiert die Raumliste und füllt sie mit vorgegebenen Räumen.
     */
    public RoomManager(){
        rooms = new ArrayList<>();
        generateRooms();
    ...
    private void generateRooms(){
        ...
        rooms.add(new Room("Gefängnis","Du siehst vor dir ein paar alte Zellen, das muss ein altes Gefängnis sein.",RoomType.BAD));
