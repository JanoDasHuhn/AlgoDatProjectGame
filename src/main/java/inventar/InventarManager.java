...
/**
 * Die Klasse {@code InventarManager} verwaltet das Inventar des Spielers.
 * Sie ermöglicht das Hinzufügen, Entfernen und Auflisten von Items,
 * sowie das Ausrüsten von Waffen.
 */
public class InventarManager {
    ...
    /**
     * Konstruktor für {@code InventarManager}.
     ...
     * Wird eine Waffe gefunden, kann der Spieler entscheiden, sie auszurüsten.
     *
     ...
     * Verringert die Anzahl, löscht das Item, wenn kein Exemplar mehr vorhanden ist.
     *
     ...
     * sortiert nach Waffen, Boosts und interaktiven Items.
     *
    ...
    public String listItems() {
        ...
        for (WeaponItem weaponItem : weaponItems.keySet()) {
            string.append(weaponItem.getRarity().name()).append(" ")
                    .append(weaponItem.getName()).append(" ")
                    .append(weaponItems.get(weaponItem)).append("\n");
        }
        string.append("Boosts: \n");
        for (BoostItem boostItem : boostItems.keySet()) {
            string.append(boostItem.getRarity()).append(" ")
                    .append(boostItem.getName()).append(" ")
        ...
        for (InteractiveItem interactiveItem : interactiveItems.keySet()) {
            string.append(interactiveItem.getRarity()).append(" ")
                    .append(interactiveItem.getName()).append(" ")
                    .append(interactiveItems.get(interactiveItem)).append("\n");
        }
