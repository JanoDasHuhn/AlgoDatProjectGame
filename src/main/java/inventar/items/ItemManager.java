...
/**
 * Die Klasse {@code ItemManager} verwaltet einen Pool von Items. Sie ermöglicht das Hinzufügen
 * verschiedener Item-Typen und das Abrufen der Items.
 */
public class ItemManager {
  ...
  /**
   * Konstruktor für {@code ItemManager}. Erstellt eine leere Item-Liste.
   */
  public ItemManager() {
   ...
   */
  public void addItemToPool(String name, float weight, String desc, Rarity rarity, float damage,
   ...
   */
  public void addItemToPool(String name, float weight, String desc, Rarity rarity,
      float healthBoost, float speedBoost) {
